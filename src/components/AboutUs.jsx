...
const AboutUs = forwardRef((props, ref) => {
  return (
    <AboutUsSection ref={ref} {...props}>
      ...
      <Text>
        Somos uma equipe de mestres e bacharéis em Administração e Computação pela Universidade Federal Rural de Pernambuco. Acreditamos que as organizações devem atuar com responsabilidade social e ambiental, promovendo um impacto positivo na sociedade e no meio ambiente.
        <br/>
        <br/>
